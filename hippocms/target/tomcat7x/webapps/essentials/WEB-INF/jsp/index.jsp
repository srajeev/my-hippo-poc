...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/main.css?v=1.02.08"/>
  <link rel="stylesheet" href="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.min.css?v=1.02.08"/>
  <script type="application/javascript">
    window.SERVER_URL = '<%=request.getServerName()+':'+request.getServerPort()%>';
  </script>
  <script src="${pageContext.request.contextPath}/components/jquery/jquery.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/angular/angular-sanitize.min.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/chosen/chosen.jquery.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/underscore/underscore.js?v=1.02.08"></script>

  <script src="${pageContext.request.contextPath}/components/bootstrap/dist/js/bootstrap.js?v=1.02.08"></script>
  ...
  --%>
  <script src="${pageContext.request.contextPath}/js/lib/ui-bootstrap-tpls.min.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-route.min.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-ui-router.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/lib/angular-animate.js?v=1.02.08"></script>

  <%-- HIPPO THEME DEPS --%>
  <script src="${pageContext.request.contextPath}/components/angular-ui-tree/dist/angular-ui-tree.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-plugins/dist/js/main.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/components/hippo-theme/dist/js/main.js?v=1.02.08"></script>

  <%-- ESSENTIALS --%>
  <script src="${pageContext.request.contextPath}/js/Essentials.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/app.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/routes.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/directives.js?v=1.02.08"></script>
  <script src="${pageContext.request.contextPath}/js/controllers.js?v=1.02.08"></script>
